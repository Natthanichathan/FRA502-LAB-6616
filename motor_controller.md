...
```bash
ros2 topic echo /motor_feedback_publisher
```
...
```bash
ros2 topic pub --once /gain_subscription std_msgs/msg/Float32MultiArray "
layout:
  dim: []
  data_offset: 0
data: [1.0, 0.5]  
...
```bash
ros2 topic pub --once /reference_subscription std_msgs/msg/Float32MultiArray "
layout:
  dim: []
  data_offset: 0
data: [1.0, 0.0, 0.0]  
"
# ref_pos, ref_velo, ref_torque
```
